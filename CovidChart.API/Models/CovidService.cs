...
namespace CovidChart.API.Models
{
    public class CovidService
    {
        ...
        public List<CovidChart> GetCovidList()
        {
            ...
            {
                command.CommandText = "select tarih,[1],[2],[3],[4],[5]  FROM(select[ECity],[Count], Cast([CovidDate] as date) as tarih FROM Covids) as covidT PIVOT (SUM(Count) For ECity IN([1],[2],[3],[4],[5]) ) as ptable order by tarih asc";
